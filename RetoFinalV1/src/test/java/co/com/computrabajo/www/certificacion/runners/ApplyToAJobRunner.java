// This runner uses everything. When this test starts, it will
// login to computrabajo, search a job and apply to it. 
...
@CucumberOptions(
		features="src/test/resources/co/com/computrabajo/www/certificacion/features/ApplyToAJob.feature",
		glue="co.com.computrabajo.www.certificacion.stepsdefinitions",
		snippets=SnippetType.CAMELCASE
)
public class ApplyToAJobRunner {
